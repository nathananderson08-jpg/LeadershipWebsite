...
const ARTICLE_CONTENT: Record<string, string[]> = {
  "end-to-end-imperative": [
    ...
    "The most damaging moment in fragmented leadership development is the handoff — the point where one engagement ends and the next begins. Assessment results get summarized into a deck that never quite captures the nuance. Coaching engagements wrap up without any mechanism to embed insights into formal leadership development. Every handoff is an information loss event. Every information loss event means a leader starts the next phase of their leadership development without the full benefit of the phase before.",
  ...
  "engineer-to-executive": [
    ...
    "The dominant theory of manager leadership development holds that developing new leaders is primarily an additive process: you teach them the skills they don't have — giving feedback, running one-on-ones, managing performance. But for technical-to-leadership transitions specifically, the leadership development challenge is at least as much subtractive as additive. The competencies that made someone excellent as an individual contributor actively interfere with leadership.",
  ...
  "board-blind-spot": [
    ...
    "The boards that have moved beyond the HR-update model do four things differently: they separate pipeline discussions from performance discussions; they ask for leading indicators, not lagging ones; they connect leadership development investment to strategy explicitly; and they hold the CEO accountable for talent leadership development, not just talent acquisition.",
