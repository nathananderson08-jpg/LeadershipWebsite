...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive leadership diagnostics including 360 reviews, psychometric assessments, high-potential identification, and organizational audits. Integrated with coaching and development for measurable outcomes.",
}
...
export default function AssessmentPage() {
  return (
    <SolutionPageTemplate
      ...
      heroSubtitle="Our assessment practice goes beyond generating data — we translate diagnostic insights directly into actionable development plans. Assessment is where transformation begins, and where strategy meets the individual."
      ...
      challengePoints={[
        "360 feedback delivered without coaching or follow-through creates anxiety, not development.",
        "Organizational diagnostics disconnected from development planning waste budget and erode trust.",
      ...
      approachBody="We design every assessment to feed directly into coaching plans, development programs, and succession strategies. A diagnosis without a treatment plan is incomplete — and an assessment without integration is a missed opportunity."
      features={[
        {
          icon: "🔄",
          title: "360-Degree Leadership Reviews",
          description: "Multi-rater feedback from direct reports, peers, and managers, contextualized by our expert coaches. Every 360 includes a debrief session and is tied directly to a development plan. Available for individuals and leadership teams.",
        },
        {
          icon: "🧠",
        ...
        },
        {
          ...
          description: "Structured assessments for specific transitions: new manager, director, VP, and C-suite. Provides benchmarked readiness profiles and targeted development priorities for individuals preparing to step up.",
        },
      ]}
      audiences={[
        "HR and talent teams seeking rigorous data to inform development investment",
      ...
      engagementModels={[
        {
          ...
          description: "Full psychometric battery + 360-degree review + expert debrief + integrated development planning session. Ideal as a coaching intake or standalone development investment.",
        },
        {
