...
export default function GovernmentPage() {
  return (
    <IndustryPageTemplate
      ...
      challenges={[
        { title: "Public Accountability & Trust", desc: "Government leaders must perform in a fishbowl — every decision visible, every failure magnified. Building the resilience and judgment for that environment is a distinct leadership development need." },
      ...
      lifecycleApplication={[
        ...
        { phase: "05 Sustain", detail: "Succession planning for senior civil service roles, with particular attention to the leadership development of diverse leadership pipelines in public sector organizations." },
      ]}
      insights={[
