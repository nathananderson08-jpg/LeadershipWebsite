  ...
  return (
    <IndustryPageTemplate
      ...
      challenges={[
        ...
        { title: "Cross-Functional Collaboration Under Pressure", desc: "Drug development and commercialization require R&D, clinical, regulatory, medical affairs, and commercial functions to work together seamlessly — often under significant time and competitive pressure." },
      ...
      lifecycleApplication={[
        ...
        { phase: "03 Develop", detail: "Scientist-to-leader development programs, cross-functional leadership curricula, and commercial leadership tracks for leaders transitioning from R&D into general management roles." },
        ...
        { phase: "05 Sustain", detail: "Succession planning for key scientific and commercial leadership roles, high-potential identification across the organization, and pipeline development for the next generation of senior leaders." },
      ]}
      insights={[
