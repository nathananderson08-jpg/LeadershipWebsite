...
export default function HospitalityPage() {
  return (
    <IndustryPageTemplate
      ...
      challenges={[
        { title: "Frontline Service Leadership", desc: "The quality of a hotel, airline, or resort is ultimately defined by its frontline team leads and supervisors. Building leadership capability in high-volume, high-turnover environments requires systematic development at scale." },
      ...
      lifecycleApplication={[
        ...
        { phase: "03 Develop", detail: "Frontline supervisor development programs, GM academies for emerging property leaders, and brand ambassador leadership curricula that connect culture, service standards, and leadership behavior." },
        ...
        { phase: "05 Sustain", detail: "Succession planning for GM and regional director roles, high-potential identification across the property network, and leadership pipeline development for long-term organizational resilience." },
      ]}
      insights={[
