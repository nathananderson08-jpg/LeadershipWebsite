  ...
  return (
    <IndustryPageTemplate
      ...
      challenges={[
        ...
        { title: "Scaling Impact Without Losing Mission", desc: "Growth is complicated for mission-driven organizations. Leaders who can scale programs, partnerships, and operations without diluting purpose or culture are rare and need leadership development." },
      ]}
      lifecycleApplication={[
        ...
        { phase: "05 Sustain", detail: "Succession planning for executive director and C-suite roles, leadership pipeline leadership development, and continuity planning for founder-led organizations." },
      ]}
      insights={[
